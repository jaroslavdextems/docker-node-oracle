...
RUN sudo touch /etc/ld.so.conf.d/oracle_instant_client.conf && echo '/opt/oracle/instantclient/' | sudo tee -a /etc/ld.so.conf.d/oracle_instant_client.conf && sudo ldconfig
